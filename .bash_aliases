...
source ~/bin/langrc
export NODE_PATH=.:./my_modules:./node_modules:~/.nvm/versions/v0.12.0/lib/node_modules:/usr/local/lib/node_modules:/usr/lib/node_modules:/usr/local/share/npm/lib/node_modules:$NODE_PATH
export EDITOR=vi
export APP=~/my/app
